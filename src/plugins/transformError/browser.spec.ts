...
describe('Transform error plugin', () => {
    ...
    it('should not transform error', () => {
        ...
        const transformResult = plugin.transform({
            error,
            errorInfo: {
                ...baseErrorInfo,
            },
    ...
    it('should transform dependants', () => {
        const { errorInfo } = plugin.transform({
    ...
    it('should not transform name to appName if name is not application name', () => {
        let transformResult = plugin.transform({
            error: new Error('Test error'),
            errorInfo: {
                ...baseErrorInfo,
                dependants: [],
        ...
        transformResult = plugin.transform({
            error: new Error('Test error'),
            errorInfo: {
                ...baseErrorInfo,
                dependants: [],
